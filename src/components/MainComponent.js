...
const mapDispatchToProps = dispatch => ({
    addNewStaff: (id, name, doB, startDate, departmentId, salaryScale, annualLeave, overTime, image) => dispatch(addNewStaff(id, name, doB, startDate, departmentId, salaryScale, annualLeave, overTime, image)),
    fetchStaffs: () => { dispatch(fetchStaffs()) },
    fetchDepartments: () => { dispatch(fetchDepartments()) },
    fetchSalary: () => { dispatch(fetchSalary()) },
    deleteStaff: (id) => dispatch(deleteStaff(id)),
    updateStaff: (id, name, doB, startDate, departmentId, salaryScale, annualLeave, overTime, image) => dispatch(updateStaff(id, name, doB, startDate, departmentId, salaryScale, annualLeave, overTime, image))
})
